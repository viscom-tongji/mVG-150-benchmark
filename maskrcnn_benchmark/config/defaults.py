...
# hierarchical predicate modeling for PrototypeEmbeddingNetwork_v1
_C.MODEL.ROI_RELATION_HEAD.HIERARCHY = CN(new_allowed=True)
_C.MODEL.ROI_RELATION_HEAD.HIERARCHY.ENABLED = True
_C.MODEL.ROI_RELATION_HEAD.HIERARCHY.COARSE_PREDICATES = []
_C.MODEL.ROI_RELATION_HEAD.HIERARCHY.FINE_PREDICATES = []
_C.MODEL.ROI_RELATION_HEAD.HIERARCHY.FINE_TO_COARSE = CN(new_allowed=True)
_C.MODEL.ROI_RELATION_HEAD.HIERARCHY.USE_CANDIDATE_MASK = True
_C.MODEL.ROI_RELATION_HEAD.HIERARCHY.USE_COARSE_TO_FINE_BIAS = True
_C.MODEL.ROI_RELATION_HEAD.HIERARCHY.USE_RESIDUAL_CORRECTION = True
_C.MODEL.ROI_RELATION_HEAD.HIERARCHY.HIERARCHY_LOSS_WEIGHT = 1.0
_C.MODEL.ROI_RELATION_HEAD.HIERARCHY.COARSE_LOSS_WEIGHT = 1.0
_C.MODEL.ROI_RELATION_HEAD.HIERARCHY.FINE_PROTO_WEIGHT = 1.0
_C.MODEL.ROI_RELATION_HEAD.HIERARCHY.COARSE_PROTO_WEIGHT = 1.0
_C.MODEL.ROI_RELATION_HEAD.HIERARCHY.PROTO_REG_WEIGHT = 1.0
_C.MODEL.ROI_RELATION_HEAD.HIERARCHY.CANDIDATE_MASK_ALPHA = 1.0
_C.MODEL.ROI_RELATION_HEAD.HIERARCHY.COARSE_TO_FINE_BIAS_BETA = 0.5
_C.MODEL.ROI_RELATION_HEAD.HIERARCHY.RESIDUAL_CORRECTION_LAMBDA = 0.5
_C.MODEL.ROI_RELATION_HEAD.HIERARCHY.CONSISTENCY_TYPE = "symmetric"
_C.MODEL.ROI_RELATION_HEAD.HIERARCHY.MASK_EPSILON = 1e-6
_C.MODEL.ROI_RELATION_HEAD.HIERARCHY.COARSE_TEMPERATURE = 0.07
_C.MODEL.ROI_RELATION_HEAD.HIERARCHY.COARSE_MARGIN = 1.0
_C.MODEL.ROI_RELATION_HEAD.HIERARCHY.FINE_MARGIN = 1.0
_C.MODEL.ROI_RELATION_HEAD.HIERARCHY.COARSE_TOPK_NEG = 5
_C.MODEL.ROI_RELATION_HEAD.HIERARCHY.FINE_TOPK_NEG = 10
_C.MODEL.ROI_RELATION_HEAD.HIERARCHY.PROTOTYPE_MARGIN = 7.0
_C.MODEL.ROI_RELATION_HEAD.HIERARCHY.PROTOTYPE_TOPK_NEG = 1

_C.MODEL.ROI_RELATION_HEAD.EXPERTS = CN(new_allowed=True)
_C.MODEL.ROI_RELATION_HEAD.EXPERTS.ENABLED = False
_C.MODEL.ROI_RELATION_HEAD.EXPERTS.ROUTE_RESIDUAL_RATIO = 0.1
_C.MODEL.ROI_RELATION_HEAD.EXPERTS.RESPONSIBILITY_IN_WEIGHT = 1.0
_C.MODEL.ROI_RELATION_HEAD.EXPERTS.RESPONSIBILITY_OUT_WEIGHT = 0.2
_C.MODEL.ROI_RELATION_HEAD.EXPERTS.ADAPTER_HIDDEN_DIM = 512
_C.MODEL.ROI_RELATION_HEAD.EXPERTS.ADAPTER_INSIDE_SCALE = 1.0
_C.MODEL.ROI_RELATION_HEAD.EXPERTS.ADAPTER_OUTSIDE_SCALE = 0.1
_C.MODEL.ROI_RELATION_HEAD.EXPERTS.EXPERT_TEMPERATURE = 0.07
_C.MODEL.ROI_RELATION_HEAD.EXPERTS.OWNER_LOSS_WEIGHT = 0.5
_C.MODEL.ROI_RELATION_HEAD.EXPERTS.OWNED_PROTO_WEIGHT = 0.25
_C.MODEL.ROI_RELATION_HEAD.EXPERTS.NONOWNED_ANCHOR_WEIGHT = 0.02
_C.MODEL.ROI_RELATION_HEAD.EXPERTS.GATE_SPARSE_WEIGHT = 1e-4

_C.MODEL.ROI_RELATION_HEAD.EXPERTS.SPATIAL_OVERLAP = CN(new_allowed=True)
_C.MODEL.ROI_RELATION_HEAD.EXPERTS.SPATIAL_OVERLAP.ENABLED = False
_C.MODEL.ROI_RELATION_HEAD.EXPERTS.SPATIAL_OVERLAP.HIDDEN_DIM = 512
_C.MODEL.ROI_RELATION_HEAD.EXPERTS.SPATIAL_OVERLAP.LOSS_WEIGHT = 0.5
_C.MODEL.ROI_RELATION_HEAD.EXPERTS.SPATIAL_OVERLAP.GATE_HIDDEN_DIM = 512
_C.MODEL.ROI_RELATION_HEAD.EXPERTS.SPATIAL_OVERLAP.OVERLAP_PREDICATES = []

_C.MODEL.ROI_RELATION_HEAD.EXPERTS_LITE = CN(new_allowed=True)
_C.MODEL.ROI_RELATION_HEAD.EXPERTS_LITE.ENABLED = False
_C.MODEL.ROI_RELATION_HEAD.EXPERTS_LITE.ADAPTER_HIDDEN_DIM = 512
_C.MODEL.ROI_RELATION_HEAD.EXPERTS_LITE.OWNER_LOSS_WEIGHT = 0.25
_C.MODEL.ROI_RELATION_HEAD.EXPERTS_LITE.OWNED_PROTO_WEIGHT = 0.10
_C.MODEL.ROI_RELATION_HEAD.EXPERTS_LITE.OWNER_LOGIT_ALPHA = 0.5
_C.MODEL.ROI_RELATION_HEAD.EXPERTS_LITE.ROUTING_TOPK = 2
